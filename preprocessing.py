...
2. domain: ex: 'music'
Command Example: python preprocessing.py no-sample music
"""
import sys
...
try:
    ...
    print("Error Message:\nArgument expected for sampling: no-sample | up-sample | down-sample")
    exit()
...
pickle.dump(train_sentences, open('dataset/' + domain + '/train_sentences.pkl', 'wb'))
pickle.dump(val_sentences, open('dataset/' + domain + '/val_sentences.pkl', 'wb'))
pickle.dump(test_sentences, open('dataset/' + domain + '/test_sentences.pkl', 'wb'))
pickle.dump(train_labels, open('dataset/' + domain + '/train_labels.pkl', 'wb'))
pickle.dump(val_labels, open('dataset/' + domain + '/val_labels.pkl', 'wb'))
pickle.dump(test_labels, open('dataset/' + domain + '/test_labels.pkl', 'wb'))

pickle.dump(word2idx, open('dataset/' + domain + '/word2idx.pkl', 'wb'))
pickle.dump(idx2word, open('dataset/' + domain + '/idx2word.pkl', 'wb'))
